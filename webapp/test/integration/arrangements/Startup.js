sap.ui.define([
	"sap/ui/test/Opa5",
	"opensap/manageproducts/ManageProducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("opensap.manageproducts.ManageProducts.test.integration.arrangements.Startup", {
